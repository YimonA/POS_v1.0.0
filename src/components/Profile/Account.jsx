      ...
      <div className="">
        <div className="px-10 h-fit bg-[var(--sidebar-color)]">
          <div className=" flex justify-between items-center">
            ...
            <div className="w-fit">
              <h1 className=" text-[26px] text-white font-semibold">{profileData?.name} </h1>
...
Address              </p>
            ...
            <div className="w-fit flex flex-col gap-5 basis-1/2 ps-10">
              ...
              <p className=" font-medium text-[18px] text-white">: {profileData?.gender}</p>
              <p className=" font-medium text-[18px] text-white">: {profileData?.phone_number}</p>
              <p className=" font-medium text-[18px] text-white">: {profileData?.email}</p>
              <p className=" font-medium text-[18px] text-white">
                : {profileData?.address}
              </p>
            </div>
